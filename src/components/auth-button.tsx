...
export function AuthButton({ isAuthenticated, userImage }: AuthButtonProps) {
  ...
  return isAuthenticated ? (
    ...
    <button
      ...
      className="hover:bg-gray-750 flex w-full items-center justify-center gap-2 rounded-lg bg-gray-800 p-3 text-sm text-gray-300 focus:outline-hidden focus:ring-2 focus:ring-blue-400"
    >
